...
export const FAQ_BY_GUIDE: Record<string, Array<{ question: string; answer: string }>> = {
  'como-elegir-bomba-agua': [
    ...
    {
      question: '¿Qué bomba necesito para alimentar aspersores de riego?',
  ...
  'instalacion-riego-goteo': [
    ...
    {
      question: '¿Cuál es la diferencia entre riego por goteo y aspersión?',
      answer: 'El goteo aplica agua directamente en la zona radicular con 90-95% de eficiencia, ideal para hortalizas, frutales y viñedos. La aspersión distribuye agua en área extensiva con 70-85% de eficiencia, ideal para praderas y cultivos extensivos.',
    },
  ],
  'mantenimiento-piscinas': [
    {
      question: '¿Cuánto cloro necesita una piscina de 50.000 litros?',
      answer: 'Aproximadamente 250-500g de cloro granulado por aplicación para alcanzar 1-3 ppm. La dosis exacta depende del pH actual y la temperatura del agua.',
    },
    {
      question: '¿Cada cuánto hay que tratar el agua de la piscina?',
      answer: 'En verano con uso frecuente, chequea cloro y pH cada 2-3 días. En invierno, una vez por semana es suficiente.',
    },
  ],
};
