...
export default function PageHeader({ title, description, badge, children, className = '' }: PageHeaderProps) {
  return (
    <section className={`relative overflow-hidden bg-gradient-to-b from-white via-slate-50 to-slate-200/40 text-slate-900 border-b border-slate-200/50 pt-20 pb-8 lg:pt-24 lg:pb-12 ${className}`}>
      {/* Background glow effects */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-blue-300/20 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-72 h-72 bg-sky-300/20 blur-[100px] rounded-full pointer-events-none" />
